...
!function (t) {
    ...
    return function (t) {
        ...
        const Qo = {"⌘": "ctrl", "⇧": "shift", "⌥": "alt"}, Yo = {ctrl: "⌘", shift: "⇧", alt: "⌥"}, Xo = function () {
            const t = {
                arrowleft: 37,
                arrowup: 38,
                arrowright: 39,
        ...
        class zi {
            ...
            * domChildrenToView(t, e = {}) {
            ...
            _processDataFromDomText(t) {
                ...
                return i && (e = e.replace(/^ /, "")), r && (e = e.replace(/ $/, "")), e = (e = yi(new Text(e))).replace(/ \u00A0/g, "  "), i && (e = e.replace(/^\u00A0/, " ")), Pi(o) && " " != o.data.charAt(0) || (e = e.replace(/\u00A0( *)$/, " $1")), e
            }
